...
public abstract class StaticTestPipeline<TResult> : TestPipelineBase<TResult, StaticSpec<TResult>>
{
    protected StaticTestPipeline(StaticSpec<TResult> parent) : base(parent) { }
}

public class StaticTestPipeline<TValue, TResult> : StaticTestPipeline<TResult>, ITestPipeline<TValue, TResult>
{
...
public class StaticTestPipeline<TValue1, TValue2, TResult>
    : StaticTestPipeline<TResult>, ITestPipeline<TValue1, TValue2, TResult>
{
    public StaticTestPipeline(StaticSpec<TResult> parent) : base(parent) { }
...
public class StaticTestPipeline<TValue1, TValue2, TValue3, TResult>
    : StaticTestPipeline<TResult>, ITestPipeline<TValue1, TValue2, TValue3, TResult>
{
    public StaticTestPipeline(StaticSpec<TResult> parent) : base(parent) { }
