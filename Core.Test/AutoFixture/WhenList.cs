...
public class WhenList : SubjectSpec<Retreiver, Model[]>
{
    ...
    {
        public GivenOneElement() => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(One<Model>()));
    ...
    public class GivenOneElementWithSetup : WhenList
    {
        public GivenOneElementWithSetup()
            => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(One<Model>(_ => _.Name = A<string>())));
    ...
    {
        public GivenTwoElements() => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>()));
    ...
    public class GivenTwoElementsWithSetup : WhenList
    {
        public GivenTwoElementsWithSetup() 
            => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>(_ => _.Name = A<string>())));
        [Fact] public void ThenArrayHasTwoElements() => Then().Result.Has().Count(2);
    ...
    public class GivenTwoElementsWithIndexedSetup : WhenList
    {
        public GivenTwoElementsWithIndexedSetup() 
            => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>((_, i) => _.Name = $"X{i + 1}")));
        [Fact] public void ThenArrayHasTwoElements() => Then().Result.Has().Count(2);
    ...
    {
        public GivenThreeElements() => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Three<Model>()));
    ...
    {
        public GivenFourElements() => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Four<Model>()));
    ...
    {
        public GivenFiveElements() => Given<IRepository>(_ => _.Setup(_ => _.List()).Returns(Five<Model>()));
