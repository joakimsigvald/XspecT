...
public class WhenList : SubjectSpec<Retreiver, Model[]>
{
    ...
    {
        public GivenOneElement() => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(One<Model>()));
    ...
    public class GivenOneElementWithSetup : WhenList
    {
        public GivenOneElementWithSetup()
            => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(One<Model>(_ => _.Name = A<string>())));
    ...
    {
        public GivenTwoElements() => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>()));
    ...
    public class GivenTwoElementsWithSetup : WhenList
    {
        public GivenTwoElementsWithSetup() 
            => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>(_ => _.Name = A<string>())));
        [Fact] public void ThenArrayHasTwoElements() => Then().Result.Has().Count(2);
    ...
    public class GivenTwoElementsWithIndexedSetup : WhenList
    {
        public GivenTwoElementsWithIndexedSetup() 
            => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Two<Model>((_, i) => _.Name = $"X{i + 1}")));
        [Fact] public void ThenArrayHasTwoElements() => Then().Result.Has().Count(2);
    ...
    {
        public GivenThreeElements() => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Three<Model>()));
    ...
    {
        public GivenFourElements() => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Four<Model>()));
    ...
    {
        public GivenFiveElements() => GivenThat<IRepository>(_ => _.Setup(_ => _.List()).Returns(Five<Model>()));
