...
public class WhenGet : SubjectSpec<Retreiver, Model>
{
    ...
    public void AThird_Value_Mentioned_Twice_Is_Same_Value()
        => Given<IRepository>(_ => _.Setup(_ => _.Get(The<int>())).Returns(AThird<Model>()))
